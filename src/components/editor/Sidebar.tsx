...
export function Sidebar() {
  const { activeSidebarTab, setActiveSidebarTab, sidebarCollapsed, toggleSidebar } = useUIStore();
  ...
  return (
    <div className={cn('flex h-full border-r border-slate-200 bg-white transition-all duration-200', sidebarCollapsed ? 'w-12' : 'w-72')}>
      {/* Tab icons column */}
...
function UploadsPanel() {
  ...
  return (
    <div className="p-3">
      ...
      <div className="mt-4">
        <h4 className="text-xs font-semibold text-slate-500 mb-2">Stock Photos</h4>
